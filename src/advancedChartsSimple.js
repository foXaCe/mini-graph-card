/**
 * Simplified advanced chart types compatible with ESLint
 * Supports basic implementations of stacked area, candlestick, and multi-axis charts
 */
...
export class AdvancedCharts {
  ...
  handleStackedHover(event, layer, index) {
    ...
    if (typeof window !== 'undefined' && typeof window.CustomEvent !== 'undefined') {
      target.dispatchEvent(new window.CustomEvent('chart-hover', {
        detail,
        bubbles: true,
      }));
    }
  ...
  handleCandleHover(event, candle, index) {
    ...
    if (typeof window !== 'undefined' && typeof window.CustomEvent !== 'undefined') {
      rect.dispatchEvent(new window.CustomEvent('chart-hover', {
        detail,
        bubbles: true,
      }));
    }
