    ...
    `}_select(t,e,i,n){return F`
      <div class="form-group">
        ...
        <ha-select
          ...
          .naturalMenuWidth=${!0}
          .fixedMenuPosition=${!0}
          @selected=${t=>this._selectChanged(t,i,e)}
        ...
        <div class="form-row">
          ...
          <div class="form-group">
            ...
            <ha-select
              ...
              .naturalMenuWidth=${!0}
              .fixedMenuPosition=${!0}
              @selected="${t=>this._entitySelectChanged(t,e,"y_axis",i.y_axis||"primary")}"
              @closed="${t=>t.stopPropagation()}"
            >
